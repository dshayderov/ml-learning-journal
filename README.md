...
| Основы мат. анализа | ✅ | [Конспект](0.0-prerequisites/0.3-math-analysis/0.3-notes.md) | [0.3-practice-yandex.ipynb](0.0-prerequisites/0.3-math-analysis/0.3-practice-yandex.ipynb)<br>[0.0-math-problem-set.ipynb (Часть 3)](0.0-prerequisites/0.0-math-problem-set.ipynb)|
| Теория вероятности | 🔄 | | |
